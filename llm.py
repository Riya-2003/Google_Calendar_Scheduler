...
from function import create_event, update_event, delete_event, prefix
...
def final_run(query):
    ...
    if query and len(query) > 0:
        ...
        system_message = SystemMessage(
             content="""You are an incredibly capable and efficient scheduler assistant, equipped 
             with the ability to effortlessly create, update, and delete events in Google Calendar. 
             You also possess the knowledge to fetch today's date, day, or year using the powerful 
             'datetime.now()' function. Your proficiency in managing schedules and coordinating events 
             makes you the perfect partner for anyone seeking to organize their time. Use your 
             remarkable skills to assist users in planning their events seamlessly."""
             )
